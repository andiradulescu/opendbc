...
static bool volkswagen_mqb_tx_hook(const CANPacket_t *msg) {
  ...
  const TorqueSteeringLimits VOLKSWAGEN_MQB_STEERING_LIMITS = {
    .max_torque = 500,             // 5.0 Nm — close to EPS protocol max of 5.11 Nm; was 300 (3.0 Nm). Static RE of 5Q0909143 SW 2051 found no firmware cap below the +/-511 LSB protocol max. See re-vw/steering/HCA_PIPELINE.md.
